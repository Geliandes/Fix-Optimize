function CardMob() {
  ...
  function modalInfo() {
      ...
      var inputEleC = document.querySelector("#inputCupom");
      var inputEleButtonC = document.querySelector(
          ".ButtonCardEminicard.btnCupom"
      );

      inputEleC.addEventListener("keyup", function (e) {
          var key = e.which || e.keyCode;
          if (key == 13) {
              inputEleButtonC.click();
          }
      });
  }
  ...
  function EventShadow() {
      ...
      document.querySelector('.home').classList.add('is__active');
  ...
  var EpositionShadowfunc = document.querySelector('.Eposition_shadow');

  EpositionShadowfunc.addEventListener('click', OffMinicart);

  function OffMinicart() {
      Eminicart.classList.toggle("is--active");
      var Eposition = document.querySelector(".Eposition_shadow");
      Eposition.classList.toggle("Eposition_shadow-is--active");
      document.querySelector('.home').classList.remove('is__active');
  }

  home.appendChild(Eposition_shadow);
